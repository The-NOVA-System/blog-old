define("./workbox-b9733a6e.js", ["exports"], (function (t) {
    "use strict";
    try {
    ...
    class y {
        ...
        async getAllMatching(t, {
            ...
            return await this.transaction([t], "readonly", ((a, c) => {
                const o = a.objectStore(t), h = e ? o.index(e) : o, u = [], l = h.openCursor(s, n);
                l.onsuccess = () => {
                    const t = l.result;
        ...
        async g(t, e, s, ...n) {
            return await this.transaction([e], s, ((s, i) => {
                const r = s.objectStore(e), a = r[t].apply(r, n);
    ...
    for (const [t, e] of Object.entries(m)) for (const s of e) s in IDBObjectStore.prototype && (y.prototype[s] = async function (e, ...n) {
    ...
    class v {
        ...
        v(t) {
            ...
            e.createIndex("cacheName", "cacheName", {unique: !1}), e.createIndex("timestamp", "timestamp", {unique: !1}), (async t => {
        ...
        async expireEntries(t, e) {
            const s = await this.h.transaction(g, "readwrite", ((s, n) => {
                const i = s.objectStore(g).index("timestamp").openCursor(null, "prev"), r = [];
                let a = 0;
                i.onsuccess = () => {
                    const s = i.result;
                    if (s) {
    ...
    class q {
        constructor(t, e = {}) {
            this.U = !1, this.L = !1, this._ = e.maxEntries, this.N = e.maxAgeSeconds, this.C = e.matchOptions, this.R = t, this.D = new v(t)
        }

        async expireEntries() {
            if (this.U) return void (this.L = !0);
            this.U = !0;
            const t = this.N ? Date.now() - 1e3 * this.N : 0, e = await this.D.expireEntries(t, this._),
    ...
    class N {
        constructor(t, e) {
            this.T = {}, Object.assign(this, e), this.event = e.event, this.k = t, this.K = new L, this.O = [], this.P = [...t.plugins], this.M = new Map;
            for (const t of this.P) this.M.set(t, {});
        ...
        async fetch(t) {
            ...
            try {
                let t;
                t = await fetch(n, "navigate" === n.mode ? void 0 : this.k.fetchOptions);
        ...
        async cacheMatch(t) {
            const e = x(t);
            let s;
            const {cacheName: n, matchOptions: i} = this.k, r = await this.getCacheKey(e, "read"),
                a = U({}, i, {cacheName: n});
        ...
        async cachePut(t, e) {
            ...
            if (!c) return !1;
            const {cacheName: o, matchOptions: h} = this.k, u = await self.caches.open(o),
        ...
        async getCacheKey(t, e) {
            if (!this.T[e]) {
                let s = t;
                for (const t of this.iterateCallbacks("cacheKeyWillBeUsed")) s = x(await t({
                    mode: e,
                    request: s,
                    event: this.event,
                    params: this.params
        ...
        hasCallback(t) {
            for (const e of this.k.plugins) if (t in e) return !0;
            return !1
        }
        ...
        * iterateCallbacks(t) {
            for (const e of this.k.plugins) if ("function" == typeof e[t]) {
    ...
    class C {
        ...
        handleAll(t) {
            ...
            const e = t.event, s = "string" == typeof t.request ? new Request(t.request) : t.request,
                n = "params" in t ? t.params : void 0, i = new N(this, {event: e, request: s, params: n}),
                r = this.S(i, s, e);
        ...
        async S(t, e, n) {
            ...
            try {
                if (i = await this.j(e, t), !i || "error" === i.type) throw new s("no-response", {url: e.url})
            } catch (s) {
    ...
    class M extends C {
        constructor(t = {}) {
            t.cacheName = f(t.cacheName), super(t), this.I = !1 !== t.fallbackToNetwork, this.plugins.push(M.copyRedirectedCacheableResponsesPlugin)
        }
        ...
        async H(t, e) {
            let n;
            if (!this.I) throw new s("missing-precache-entry", {cacheName: this.cacheName, url: t.url});
        ...
        $() {
            let t = null, e = 0;
            for (const [s, n] of this.plugins.entries()) n !== M.copyRedirectedCacheableResponsesPlugin && (n === M.defaultPrecacheCacheabilityPlugin && (t = s), n.cacheWillUpdate && e++);
            0 === e ? this.plugins.push(M.defaultPrecacheCacheabilityPlugin) : e > 1 && null !== t && this.plugins.splice(t, 1)
        }
    }

    M.defaultPrecacheCacheabilityPlugin = {cacheWillUpdate: async ({response: t}) => !t || t.status >= 400 ? null : t}, M.copyRedirectedCacheableResponsesPlugin = {cacheWillUpdate: async ({response: t}) => t.redirected ? await P(t) : t};

    class A {
        constructor({cacheName: t, plugins: e = [], fallbackToNetwork: s = !0} = {}) {
            this.G = new Map, this.V = new Map, this.J = new Map, this.k = new M({
                cacheName: f(t),
        ...
        addToCacheList(t) {
            ...
            for (const n of t) {
                ...
                if ("string" != typeof n && n.integrity) {
                    if (this.J.has(t) && this.J.get(t) !== n.integrity) throw new s("add-to-cache-list-conflicting-integrities", {url: i});
        ...
        createHandlerBoundToURL(t) {
            ...
            return s => (s.request = new Request(t), s.params = U({cacheKey: e}, s.params), this.strategy.handle(s))
        }
    }
