...
define("./sw.js", ["./workbox-b9733a6e"], (function (s) {
    ...
    }, {url: "assets/img/NOVA System logo.png", revision: "453e41f26b86ec7bfc5c1a02db242f1d"}, {
    ...
    }, {url: "feed.xml", revision: "b01fbb7769b587544d74b06627ebb540"}, {
        url: "index.html",
        revision: "805aa69ad54f46eea61ed0c6754cc83f"
    }, {url: "loadFeed.js", revision: "8461e3ce9663eb2447f5351d11446120"}, {
        url: "manifest.json",
        revision: "d1f992474c31cafeb24376f39a6dfba5"
    }, {url: "posts/Test.html", revision: "bafeff6bbd2dd7fbe7a8c3c2b819b4de"}, {
        url: "posts/TestPost.html",
        revision: "845f9cdd2e0e88771823871ac84d04ea"
    }, {url: "README.md", revision: "4309a40351ef7610145f5ed28067d63e"}, {
        url: "service-worker.js",
        revision: "30ac1328917b0df3ae6b459e9c95d84b"
    }, {url: "sitemap.xml", revision: "8ce99082a14bc936cdfd92349880450a"}, {
        url: "static/cat.gif",
        revision: "25271ec504557e7fa3e50174bf76a74d"
    }, {url: "static/dance.gif", revision: "4e99346e12f224041cb92188e6c30448"}, {
        url: "sw-register.js",
        revision: "0f9a6ffe2ed32f8327762d908d0b5366"
    }], {ignoreURLParametersMatching: [/^utm_/, /^fbclid$/]}), s.registerRoute(/\.(?:png|jpg|jpeg|svg)$/, new s.CacheFirst({
        cacheName: "images",
        plugins: [new s.ExpirationPlugin({maxEntries: 15, purgeOnQuotaError: !0})]
    }), "GET")
}));
