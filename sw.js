if (!self.define) {
  const s = s => {
    ...
    return o[s] || (e = new Promise((async e => {
                      if ("document" in self) {
...
define(
    "./sw.js", [ "./workbox-b9733a6e" ], (function(s) {
      "use strict";
      self.addEventListener("message",
                            (s => {s.data && "SKIP_WAITING" === s.data.type &&
                                   self.skipWaiting()})),
          s.precacheAndRoute(
              [
                {
                ...
                {
                  url :
                      "assets/js/workbox-v5.1.4/workbox-background-sync.dev.js",
                  revision : "e6c466ef158b91df55fa3dd1f1fc79ee"
                },
                {
                  url :
                      "assets/js/workbox-v5.1.4/workbox-background-sync.prod.js",
                  revision : "1e8c38916345d2843226a60ca686cc54"
                },
                {
                  url :
                      "assets/js/workbox-v5.1.4/workbox-broadcast-update.dev.js",
                  revision : "9d6333ec473f7fc15bb00b6bd1a30a02"
                },
                {
                  url :
                      "assets/js/workbox-v5.1.4/workbox-broadcast-update.prod.js",
                  revision : "f0a1d0037b9e038b362d7cf48460b8e9"
                },
                {
                  url :
                      "assets/js/workbox-v5.1.4/workbox-cacheable-response.dev.js",
                  revision : "d688a5d580b0f9eee7e68c1746a4a750"
                },
                {
                  url :
                      "assets/js/workbox-v5.1.4/workbox-cacheable-response.prod.js",
                ...
                {
                  url :
                      "assets/js/workbox-v5.1.4/workbox-navigation-preload.dev.js",
                  revision : "19b25c9559a0bf170cce20bccb8d6a33"
                },
                {
                  url :
                      "assets/js/workbox-v5.1.4/workbox-navigation-preload.prod.js",
                ...
                {
                  url :
                      "assets/js/workbox-v5.1.4/workbox-range-requests.dev.js",
                  revision : "7595027fcc4daee68d0904ebb2a0e5c5"
                },
                {
                  url :
                      "assets/js/workbox-v5.1.4/workbox-range-requests.prod.js",
          ...
          s.registerRoute(/\.(?:png|jpg|jpeg|svg)$/, new s.CacheFirst({
            cacheName : "images",
